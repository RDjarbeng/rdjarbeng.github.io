...
* **Seamless Onboarding & Setup:** Existing IDE users are automatically updated into the standalone application. During setup, users can install tailored plugins like _Modern Web Guidance_ and _Chrome Dev Tools_ to give the AI agent deep integration into the Google ecosystem. Everything is organized around "Projects" where you can drop folders or Git repositories.
