...
type: cover
link: /Install_NodeJs_on_Raspberry_Pi
image_alt: Node.js download page showing installer options for Windows, macOS, and Linux platforms to install version 20.9.0.
