...
type: external
category: memes
image_alt: A social media post screenshot showcasing a cat named F.D.C. Willard listed as an author on three physics research papers.
enhanced_by_bot: true
---

The most knowledgeable cat by citations.

This cat has published 3 physics papers including one on '[Solid helium 3: a nuclear antiferromagnetic element](https://www.osti.gov/etdeweb/biblio/5974612)'

Explained by user [@paularambles on Twitter/X](https://x.com/paularambles/status/2033377779832741893)There’s actually a fun backstory to this: the owner of this cat, a physicist, had written a paper using “we,” but the journal wouldn’t allow plural pronouns for a single author, so rather than retyping the whole manuscript (on a typewriter), he just added his cat as a co-author
