...
type: cover
link: /programming_lex_fridman
image_alt: A man in a suit speaking into a microphone next to a graphic showing a blue hexagonal logo transitioning to a Python programming language logo.
