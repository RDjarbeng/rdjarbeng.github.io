...
I am a Computer Engineer and Machine Learning Enthusiast with a passion for Internet of Things (IoT) and AI applications. I specialize in building data-driven solutions and deploying low-cost technologies for real-world impact. Currently, I am expanding my expertise in Deep Learning and building on AWS.
</p>
</div>
  ...
  <div class="cards-grid" id="projects-grid">
    ...
    <div class="project-card-about" data-category="web iot web research">
      ...
      <div class="project-content">
        ...
        <p class="project-desc">Developed an interactive dashboard to analyze PM2.5 air quality trends in Kigali, Rwanda, using data from US Embassy reference monitors. Investigates diurnal and seasonal patterns to highlight public health risks.</p>
    ...
    <div class="project-card-about projects-hidden" data-category="data">
      ...
      <div class="project-content">
        ...
        <p class="project-desc">Leveraged BigQuery ML to predict customer purchase behavior, improving marketing ROI by 9x through targeted analysis of first-time visitors.</p>
      </div>
    </div>
