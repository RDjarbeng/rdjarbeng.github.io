...
2. Check current market price and bid/ask spread
3. Decide on position size (start with 2-5% of your portfolio)
4. Choose order type (limit order recommended)
5. Enter quantity and price
6. Review and confirm the order
7. Monitor execution and keep records
