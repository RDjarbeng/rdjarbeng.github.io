...
Here is an example of uploading a meme. The bot automatically commits both the image and the generated markdown directly to the repository:

![Telegram Bot uploading a meme to the repository](/assets/images/grouped/spongebob_meme_commit_telegram.jpg)

![GitHub commit generated by the Telegram Bot](/assets/images/grouped/spongebob_meme_commit_github.jpg)
