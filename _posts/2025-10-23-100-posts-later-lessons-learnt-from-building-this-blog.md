...
When I mention *1st draft post*, it may go through many iterations and is usually the nth version, but it's usually the version that I find suitable to publish but could use improvement so that's what is sent to the editor.
