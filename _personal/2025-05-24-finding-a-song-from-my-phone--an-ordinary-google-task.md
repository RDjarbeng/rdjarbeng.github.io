...
PS: There is an easier way to bring up the find a song feature, and that involves holding the navigation bar at the bottom of the screen to show an overlay for Google lens and the find a song feature. I could add a screenshot but that will make this post too long, you're smart you'll figure it out. Advantage of this approach is that you don't need to split the screen. Cool!
