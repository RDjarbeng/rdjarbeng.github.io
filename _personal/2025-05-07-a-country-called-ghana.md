...
image_alt: Cover image for Ghana, an Introduction- All That Glitters is Still Gold with text saying introduction and a collage of many pictures
layout: personal
card_items:
  - name: Ananse the Spider
    ...
    link_text: Read Ananse Stories
  - name: Kente Cloth
    image: /assets/images/kente_cloth_design.jpg
    badge_1: Heritage
    badge_2: Traditional Weaving
    description: Ghana's iconic hand-woven silk and cotton fabric, originally worn by royalty. Each pattern tells a unique story or reflects a specific philosophy, making it a symbol of national identity.
    url: https://en.wikipedia.org/wiki/Kente_cloth
    link_text: Learn about Kente
  - name: Ghanaian Cocoa
    image: /assets/images/ghanaian_cocoa_pods.png
    badge_1: Export
    badge_2: World Class
    description: Ghana is the world's second-largest producer of cocoa. The rich soil and tropical climate produce high-quality beans that are essential to the global chocolate industry.
    url: https://en.wikipedia.org/wiki/Cocoa_production_in_Ghana
    link_text: Ghana's 'Brown Gold'
  - name: Adinkra Symbols
    image: /assets/images/adinkra_symbols_ghana.png
    badge_1: Philosophy
    badge_2: Visual Arts
    description: Visual symbols that represent concepts or aphorisms. From 'Gye Nyame' (Except God) to 'Sankofa' (Go back and get it), these symbols are deeply embedded in Ghanaian life and art.
    url: https://en.wikipedia.org/wiki/Adinkra_symbols
    link_text: Explore Symbols
---
...
![Entertainment in Ghana,from boxing to football with Asamoah Gyan on the cover](/assets/images/entertainment_ghana.png "Entertainment in Ghana,from boxing to football")
...
![Natural sites in Ghana to visit from the Kakum national park to seeing elephants in the Mole National park](/assets/images/natural_sites_ghana.png "Natural sites in Ghana to visit")
